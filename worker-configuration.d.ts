/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 24afe759264463ebd02b2a92f376744a)
// Runtime types generated with workerd@1.20260708.1 2025-04-04 
interface __BaseEnv_Env {
	STORE: DurableObjectNamespace<import("./workers/app").ClashubStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "ClashubStore";
	}
